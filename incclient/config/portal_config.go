...
type BTCPortalV4Params struct {
	NetworkName       string
	MasterPubKeys     [][]byte         `json:"MasterPubKeys,omitempty"`
	NumRequiredSigs   uint             `json:"NumRequiredSigs,omitempty"`
	MinUnShieldAmount uint64           `json:"MinUnShieldAmount,omitempty"`
	ChainParams       *chaincfg.Params `json:"ChainParams,omitempty"`
